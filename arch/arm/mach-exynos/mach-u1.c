...
#endif
#if defined(CONFIG_MACH_Q1_BD)
REGULATOR_INIT(ldo14, "VCC_2.2V_LCD", 1700000, 1700000, 1,
		REGULATOR_CHANGE_STATUS, 1);
#else
...
REGULATOR_INIT(ldo17, "VTF_2.8V", 2800000, 2800000, 0,
		REGULATOR_CHANGE_STATUS, 1);
#if defined(CONFIG_MACH_Q1_BD)
REGULATOR_INIT(ldo18, "TOUCH_LED_3.3V", 2700000, 3000000, 0,
		REGULATOR_CHANGE_STATUS, 1);
#else
...
static u8 t9_config_e[] = { TOUCH_MULTITOUCHSCREEN_T9,
	...
	10,
	0,	/* MOVHYSTI */
	10, 80, MXT540E_MAX_MT_FINGERS, 20, 40, 20, 31, 3,
