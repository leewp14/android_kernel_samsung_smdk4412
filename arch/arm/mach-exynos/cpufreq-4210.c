...
static unsigned int clkdiv_cpu0[CPUFREQ_LEVEL_END][7] = {
	...
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L6:  600MHz */
	{ 0, 3, 7, 3, 3, 1, 7 },  /* ARM L7:  500MHz */
	{ 0, 1, 3, 1, 3, 1, 7 },  /* ARM L8:  200MHz */
};
...
static unsigned int exynos4_apll_pms_table[CPUFREQ_LEVEL_END] = {
	((187 << 16)|(3 << 8)|(0x1)),	/* APLL FOUT L0: 1500MHz */
	((175 << 16)|(3 << 8)|(0x1)),	/* APLL FOUT L1: 1400MHz */
	...
	((300 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L6:  600MHz */
	((250 << 16)|(6 << 8)|(0x2)),	/* APLL FOUT L7:  500MHz */
	((200 << 16)|(6 << 8)|(0x3)),	/* APLL FOUT L8:  200MHz */
};
...
static const unsigned int asv_voltage_B[CPUFREQ_LEVEL_END][5] = {
	 ...
	 */
	{ 1375000, 1350000, 1325000, 1250000, 1225000 }, //1500MHz
