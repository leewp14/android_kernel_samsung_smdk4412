...
#else
mali_runtime_resume_table mali_runtime_resume = {266, 1000000, 1}; /* step 1 */
#endif
...
#else
			/* step 0 */{160  ,1000000      ,1000000   , 0  , 70},
			/* step 1 */{266  ,1000000	,1000000   ,62  , 90},
                        /* step 2 */{400  ,1000000      ,1100000   ,85  ,100},
#endif
};
...
static unsigned int asv_3d_volt_4210_14_table[MALI_DVFS_STEPS][ASV_LEVEL_4210_14] = {
	{  1050000,  1025000,  1000000,   975000,   950000},    /* L1(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
        {  1050000,  1025000,  1000000,   975000,   950000},    /* L1(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{  1150000,  1125000,  1100000,  1075000,  1050000},    /* L0(400Mhz) */
#endif
#endif
};
#endif
